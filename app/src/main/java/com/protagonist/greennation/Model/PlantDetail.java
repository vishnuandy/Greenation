...
public class PlantDetail implements Parcelable {
    ...
    {
        return "PlantDetail [stage_plant_emerge = "+stage_plant_emerge+", stage_fruit_growth = "+stage_fruit_growth+", stage_flowering = "+stage_flowering+", suitable_regions = "+suitable_regions+", suitable_climate_start = "+suitable_climate_start+", stage_sprout_start = "+stage_sprout_start+", plant_name = "+plant_name+", id = "+id+", plant_lifetime = "+plant_lifetime+", price = "+price+", oxygen_creation_level = "+oxygen_creation_level+", suitable_climate_end = "+suitable_climate_end+", description = "+description+", stage_full_grown_plant = "+stage_full_grown_plant+", plant_img = "+plant_img+"]";
    }

    protected PlantDetail(Parcel in) {
    ...
    public static final Parcelable.Creator<PlantDetail> CREATOR = new Parcelable.Creator<PlantDetail>() {
        @Override
        public PlantDetail createFromParcel(Parcel in) {
            return new PlantDetail(in);
        }

        @Override
        public PlantDetail[] newArray(int size) {
            return new PlantDetail[size];
        }
    };
}